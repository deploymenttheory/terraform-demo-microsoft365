...
#   filter_type  = "id"
#   filter_value = "3efff3fe-528a-4fc5-b1ba-845802cc764f" # Replace with an actual Cloud PC ID
# }

# output "cloud_pc_by_id" {
#   value = [
#     for pc in coalesce(data.microsoft365_graph_beta_windows_365_cloud_pcs.by_id.items, []) : {
#       id                       = pc.id
#       display_name             = pc.display_name
#       aad_device_id            = pc.aad_device_id
#       image_display_name       = pc.image_display_name
...
# #   filter_value = "Not provisioned" # This will match Cloud PCs with "Demo" in their name
# # }
